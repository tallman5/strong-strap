...
export const CameraVideo = ({ ...rest }: ISvg) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox='0 0 16 16' {...rest}>
...
export const CameraVideoSlash = ({ ...rest }: ISvg) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox='0 0 16 16' {...rest}>
...
export const XSquare = ({ ...rest }: ISvg) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" {...rest} viewBox="0 0 16 16">
...
export enum KnownIcon {
    ...
    ThumbDown, ThumbDownFill, ThumbUp, ThumbUpFill, XSquare
}
...
export const Icon = ({ knownIcon, ...rest }: IIcon) => {
    switch (knownIcon) {
        ...
        case KnownIcon.CameraVideo:
            return <CameraVideo {...rest} />

        case KnownIcon.CameraVideoSlash:
            return <CameraVideoSlash {...rest} />
